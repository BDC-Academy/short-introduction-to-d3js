...
function manuallyAppendColumn() {
  ...
  // TODO 1.2: Use the .append function on the svg variable and append a 'rect' to it.
  // Store the rect element in a variable 'rect'.
  // You can see in the DOM that d3 already has appended the rect to the svg.
  
  // TODO 1.3: Use the .attr function on the rect variable to set the attribute 'width' of the rect to 40.
  ...
  // This result will also be of type 'Selection'. See what the result looks like by using the browsers debugging tools and ask you teacher wtf..
...
function dynamicallyAppendColumn() {
  ...
  // But wha? There are no rect's inside our svg yet.. anymore. Ask you teacher.
  ...
  // Chain call the .remove function to .exit to remove all columns.
